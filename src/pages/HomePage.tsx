...
const HomePage: React.FC = () => {
  ...
  return (
    <div className={`overflow-hidden ${isDark ? 'bg-[#281E5A]' : 'bg-white'}`}>
      ...
      <section className="py-16 md:py-24 relative bg-[#0d0d1a]">
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[linear-gradient(rgba(214,177,102,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(214,177,102,0.02)_1px,transparent_1px)] bg-[size:40px_40px] md:bg-[size:60px_60px]" />
        </div>
